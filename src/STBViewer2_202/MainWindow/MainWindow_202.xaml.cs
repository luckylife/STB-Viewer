...
{
    public partial class MainWindow_202 : AbstractWindow
    {
        public MainWindow_202()
        {
            InitializeComponent();
            GLControl leftgLControl = new();
            _leftTreeView3DSet = new TreeView3DSet_202(LeftPanel, leftgLControl);  // 左のパネル
            GLControl rightglControl = new();
            _rightTreeView3DSet = new TreeView3DSet_202(RightPanel, rightglControl); // 右のパネル
        ...
        protected override void InitializeRightTreeView3DSet()
        {
            ...
            _rightTreeView3DSet = new TreeView3DSet_202(RightPanel, gLControl);
        ...
        {
            return "STBViewer2_202.Resources.STBridge_v202.xsd";
        }
