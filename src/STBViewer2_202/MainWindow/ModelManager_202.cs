...
namespace STBViewer2_202.MainWindow
{
    ...
    public class ModelManager_202 : AbstractModelManager
    {

        public ModelManager_202(GLControl glControl) : base(glControl)
        {
        }
        ...
        public override void LoadModelFromSTBridge(IST_BRIDGE istbData, CategorySetting categorySetting, CameraSetting cameraSetting, bool isModelB)
        {
            ...
            if (stbData.StbModel != null)
            {
                ...
                foreach (IModelElement_202 element in modelElements)
                {
