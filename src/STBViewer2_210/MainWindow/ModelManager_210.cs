...
namespace STBViewer2_210.MainWindow
{
    ...
    public class ModelManager_210 : AbstractModelManager
    {

        public ModelManager_210(GLControl glControl) : base(glControl)
        {
        }
        ...
        public override void LoadModelFromSTBridge(IST_BRIDGE istbData, CategorySetting categorySetting, CameraSetting cameraSetting, bool isModelB)
        {
            ...
            if (stbData.StbModel != null)
            {
                ...
                foreach (IModelElement_210 element in modelElements)
                {
