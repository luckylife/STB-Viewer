...
{
    public partial class MainWindow_210 : AbstractWindow
    {
        public MainWindow_210()
        {
            InitializeComponent();
            GLControl leftgLControl = new();
            _leftTreeView3DSet = new TreeView3DSet_210(LeftPanel, leftgLControl);  // 左のパネル
            GLControl rightglControl = new();
            _rightTreeView3DSet = new TreeView3DSet_210(RightPanel, rightglControl); // 右のパネル
        ...
        protected override void InitializeRightTreeView3DSet()
        {
            ...
            _rightTreeView3DSet = new TreeView3DSet_210(RightPanel, gLControl);
        ...
        {
            return "STBViewer2_210.Resources.STBridge_v210.xsd";
        }
